...
| `breakdown.copy_paste` | number (0–100) | Near-duplicate comments across videos |
...
| `sample_flagged_comments` | string[] | A few example comments for the UI to display as evidence |
